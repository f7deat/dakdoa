                    ...
                    <div className="container px-5 py-24 mx-auto">
                        <div className="flex flex-col text-center w-full mb-12">
                            ...
                            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                                Xin vui lòng để lại thông tin liên hệ của quý khách để chúng tôi có thể hỗ trợ một cách tốt nhất
                            </p>
                        </div>
                        <div className="lg:w-1/2 md:w-2/3 mx-auto">
                            <div className="flex flex-wrap -m-2">
                                ...
                                <div className="p-2 w-full">
                                    <button className="flex mx-auto text-white bg-green-700 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">Gửi Yêu Cầu</button>
                                </div>
                                <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                                    <a className="text-green-500">shinecgialai@gmai.com</a>
                                    <p className="leading-normal my-5">Cụm Công Nghiệp Số 2 Đak Đoa
                                        <br />Đak Đoa, Gia Lai, Việt Nam
                                    </p>
