...
import { FormattedMessage, Helmet, history, useIntl } from "umi"
                            ...
                            <div className="lg:w-1/2 md:w-2/3 mx-auto">
                                <div className="flex flex-wrap -m-2">
                                    ...
                                    <div className="p-2 w-full">
                                        <button
                                        type="submit"
                                        className="flex mx-auto text-white bg-green-700 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">Gửi Yêu Cầu</button>
                                    </div>
                                    <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                                        ...
                                        <p className="leading-normal my-5">Cụm Công Nghiệp Số 2 Đak Đoa
                                            <br />14 Trần Hưng Đạo, Phường Tây Sơn, TP.Pleiku, Tỉnh Gia Lai
                                        </p>
