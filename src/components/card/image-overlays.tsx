...
const CardImageOverlays: React.FC<CardImageOverlaysProps> = (props) => {
    return (
        <div className="relative card-image-overlay">
            <div className="item h-[160px] 2xl:h-[190px]">
                <a href="#">
                    <div className="text-white">
                        <img src={props.image} alt="IMG" className="w-full h-full object-cover h-[160px] 2xl:h-[190px]" loading="lazy" />
                        <div className="linear-gradient h-[160px] 2xl:h-[190px]"></div>
