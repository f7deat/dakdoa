                        ...
                        <div className="h-full 2xl:p-10 md:px-0">
                            ...
                            <div className="flex justify-between w-2/3 mx-auto mt-8">
                                ...
                                <div className="flex items-center justify-center gap-2">
                                    <button onClick={() => {carouselRef.current?.goTo(0);}} className={`h-4 md:h-5 w-4 md:w-5 rounded-full border-2 border-white ` + (0 === currentSlide ? 'bg-orange-500' : '')}></button>
                                    <button onClick={() => {carouselRef.current?.goTo(1);}} className={`h-4 md:h-5 w-4 md:w-5 rounded-full border-2 border-white ` + (1 === currentSlide ? 'bg-orange-500' : '')}></button>
                                    <button onClick={() => {carouselRef.current?.goTo(2);}} className={`h-4 md:h-5 w-4 md:w-5 rounded-full border-2 border-white ` + (2 === currentSlide ? 'bg-orange-500' : '')}></button>
