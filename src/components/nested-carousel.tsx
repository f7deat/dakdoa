    ...
    return (
        <div>
            ...
            <div className="flex justify-between w-2/3 mx-auto mt-8">
                <button className="h-14 w-14 bg-white opacity-50 rounded-full flex items-center justify-center hover:opacity-100 transition duration-500" onClick={() => carouselRef.current?.prev()}>
                ...
                <button className="h-14 w-14 bg-white opacity-50 rounded-full flex items-center justify-center hover:opacity-100 transition duration-500" onClick={() => carouselRef.current?.next()}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
