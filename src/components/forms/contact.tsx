                    ...
                    <div className="flex flex-wrap -m-2">
                        <div className="p-2 w-1/2">
                            <Form.Item name="name" rules={[
                                ...
                                <div className="relative">
                                    <label htmlFor="name" className="leading-7 text-sm text-slate-200">Họ và tên</label>
                        ...
                        <div className="p-2 w-full">
                            <Form.Item name="note" rules={[
                                ...
                                <div className="relative">
                                    <label htmlFor="message" className="leading-7 text-sm text-slate-200">Lời nhắn</label>
                        ...
                        <div className="p-2 w-full">
                            <button
                                type="submit"
                                className="flex mx-auto text-white border-2 border-white hover:bg-red-600 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">Gửi Yêu Cầu</button>
                        </div>
                        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center text-slate-200">
                            ...
                            <span className="inline-flex">
                                ...
                                <a className="ml-4 text-slate-200">
                                    <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-5 h-5" viewBox="0 0 24 24">
